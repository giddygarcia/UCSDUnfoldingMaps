...
public class EarthquakeCityMap extends PApplet {
	...
	//My extension: adding more providers
	...
	public void setup() {		
		...
		if (offline) {
		    ...
		    provider3 = new StamenMapProvider();
	...
	private void addKey() {	
		...
		textAlign(LEFT, CENTER);
		fill(0, 0, 0);
		text("Map Provider Keys", xbase+17, ybase+230);
		text("1 Google", xbase+17, ybase+250);
		text("2 Microsoft", xbase+17, ybase+270);
		text("3 Stamen", xbase+17, ybase+290);
